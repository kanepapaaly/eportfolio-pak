...
export const projects: Project[] = [
  ...
  },
  {
    ...
    problem: {
      fr: "Retrouver comment j'ai résolu un problème il y a six mois, c'est fouiller mes dépôts avec grep, qui trouve des mots mais pas des intentions. Et un RAG classique découpe le texte par taille fixe : sur du code, il coupe les fonctions en deux et le sens se perd. Déjà traite le code comme du code.",
      en: "Finding how I solved a problem six months ago means digging through my repositories with grep, which finds words, not intent. And a standard RAG splits text into fixed-size chunks: on code, that cuts functions in half and the meaning is lost. Déjà treats code as code.",
    },
    role: {
    ...
    result: {
      fr: "Une première version tourne de bout en bout sur mes propres dépôts : je pose une question en langage naturel, Déjà retrouve les fonctions concernées avec leur fichier et rédige une réponse qui les cite. Je suis maintenant dans la phase de peaufinage : mesure de la recherche sur un jeu de questions de référence, réglage de la fusion hybride, qualité des réponses.",
      en: "A first version runs end to end on my own repositories: I ask a question in plain language, Déjà finds the relevant functions with their file and writes an answer that cites them. I'm now in the refinement phase: measuring retrieval on a reference question set, tuning the hybrid fusion, improving answer quality.",
    },
    proves: {
    ...
    roadmap: [
      ...
      {
        label: { fr: "Peaufinage : évaluation (rappel@5) et réglage de la fusion hybride", en: "Refinement: evaluation (recall@5) and hybrid fusion tuning" },
        state: "current",
      },
    ],

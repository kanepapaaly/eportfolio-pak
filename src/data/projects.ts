...
export const projects: Project[] = [
  ...
  },
  {
    ...
    result: {
      fr: "En construction. Architecture et stack arrêtés, première chaîne de bout en bout en cours. Chaque étape sera mesurée sur un jeu de questions dont la bonne fonction est connue (rappel@5) : le découpage par AST et la recherche hybride devront se justifier par des chiffres.",
      en: "In progress. Architecture and stack settled, first end-to-end chain under way. Each step will be measured on a question set where the right function is known (recall@5): AST chunking and hybrid search will have to earn their place with numbers.",
    },
    proves: {
    ...
    roadmap: [
      ...
      {
        label: { fr: "Découpage par AST avec tree-sitter, mesuré contre le naïf", en: "AST chunking with tree-sitter, measured against naive" },
        state: "todo",
      },
      {
    ...
    statusTag: { fr: "En construction", en: "In progress" },
    links: [],
    images: [],
  },
  {
